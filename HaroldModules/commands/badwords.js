...
const saveFile = path.join(__dirname, 'cache', 'badwordsActive.json');
...
const saveWarnings = path.join(__dirname, 'cache', 'warnings.json');
...
const saveWarningsCount = path.join(__dirname, 'cache', 'warningsCount.json');
let warningsCount = {};
